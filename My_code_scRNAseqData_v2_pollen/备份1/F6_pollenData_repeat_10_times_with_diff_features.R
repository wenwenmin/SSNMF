...
# ------------------------------------------------------------------------------
# display results
row.names(ResMat) = c("NMF", "ONMF","ONMF_L20", "ONMF_L20_Rho","ONMF_CL0",
                      "ONMF_L0","NMF_L0","NMF_L20","NMF_CL0","Kmeans","L0_Kmeans")
...
ggsave("F4_res_pollenData_repeat_10_times_f1000.pdf", width = 7, height = 7, units = "in")
...
fileName = paste("F4_res_pollenData_repeat_10_times_f1000", ".RData", sep = "")  
save.image(fileName)
# ------------------------------------------------------------------------------